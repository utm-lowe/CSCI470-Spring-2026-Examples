...
public class Reader {
	...
	public Program parse(String programText) {
		...
		DynaLangParser p = getParser(new org.antlr.v4.runtime.CommonTokenStream(l));
		Program program = p.program().ast;
		return program;
	}
	
	protected Lexer getLexer(org.antlr.v4.runtime.ANTLRInputStream s) {
		return new DynaLangLexer(s);
	}
	
	protected DynaLangParser getParser(org.antlr.v4.runtime.CommonTokenStream s) {
		return new DynaLangParser(s);
	}
	...
	protected String getProgramDirectory() { return "build"+File.separator+"dynalang"+File.separator+"examples"+File.separator; }
